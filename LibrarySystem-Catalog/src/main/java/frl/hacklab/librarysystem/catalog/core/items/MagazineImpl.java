...
public abstract class MagazineImpl extends Literature {
  ...
  MagazineImpl(String isnn, int appearanceNumber, String title, LocalDate publicationDate, String publisher, String genre,
      String ageRating, String copyEditor, BorrowingStatus isOnLoan){
    super(title, publicationDate, publisher, genre, ageRating, copyEditor, isOnLoan);
    this.isnn = isnn;
